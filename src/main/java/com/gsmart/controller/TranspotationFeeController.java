...
public class TranspotationFeeController {
	...
	public ResponseEntity<Map<String, Object>> searchpaidtrans(@RequestBody TransportationFee trans,
	...
	public ResponseEntity<Map<String, Object>> searchunpaidtrans(@RequestBody TransportationFee trans,
			@RequestHeader HttpHeaders token, HttpSession httpSession) throws GSmartBaseException {
		Loggers.loggerStart();
		String tokenNumber = token.get("Authorization").get(0);
		String str = getAuthorization.getAuthentication(tokenNumber, httpSession);
	...
	public ResponseEntity<Map<String, Object>> addFee(@RequestBody TransportationFee taranspotationfee,
			@RequestHeader HttpHeaders token, HttpSession httpSession) throws GSmartBaseException {
	...
	public ResponseEntity<IAMResponse> editFee(@RequestBody TransportationFee transpotationfee,
	...
	public ResponseEntity<Map<String, ArrayList<TransportationFee>>> getTransportationFeeList(
			@PathVariable("smartId") String smartId, @PathVariable("academicYear") String academicYear,
			@RequestHeader HttpHeaders token, HttpSession httpSession) throws GSmartBaseException {
		Loggers.loggerStart();
		...
		ArrayList<TransportationFee> feetransportationList = (ArrayList<TransportationFee>) transpotationFeeservice
				.getTransportationFeeList(transportationFee, tokenObj.getHierarchy().getHid());
	...
	public ResponseEntity<Map<String, ArrayList<TransportationFee>>> getStudentUnpaid(
			@PathVariable("smartId") String smartId, @PathVariable("academicYear") String academicYear,
			@RequestHeader HttpHeaders token, HttpSession httpSession) throws GSmartBaseException {
		Loggers.loggerStart();
		...
		ArrayList<TransportationFee> feeList = (ArrayList<TransportationFee>) transpotationFeeservice
				.getStudentUnpaidFeeList(transportationFee, tokenObj.getHierarchy().getHid());
