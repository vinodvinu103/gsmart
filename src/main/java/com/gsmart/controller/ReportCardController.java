...
public class ReportCardController {
	...
	public ResponseEntity<Map<String, Object>> getListForStudent(@RequestHeader HttpHeaders token,
			HttpSession httpSession, @PathVariable("academicYear") String academicYear,
			@PathVariable("examName") String examName) throws GSmartBaseException {
		Loggers.loggerStart();
	...
	public ResponseEntity<Map<String, String>> excelToDB(@RequestBody MultipartFile fileUpload,
	...
	public ResponseEntity<Map<String, Object>> getReportCardStructure(@PathVariable("smartId") String smartId,
		...
		try {
			...
			// befor it is without argument List<ReportCard> allReportCards =
			// reportCardDao.reportCardList();
			...
			// HashMap<String, ArrayList<ReportCard>> childOfChild = new HashMap<String,
...
*/
	...
	public ResponseEntity<Map<String, Object>> getYear(@RequestHeader HttpHeaders token, HttpSession httpSession)
			throws GSmartBaseException {
		Loggers.loggerStart();
	...
	public ResponseEntity<Map<String, Object>> getExam(@RequestHeader HttpHeaders token, HttpSession httpSession,
	...
	public ResponseEntity<Map<String, Object>> getReportListForTeacher(@PathVariable("min") Integer min,
			@PathVariable("max") Integer max, @PathVariable("academicYear") String academicYear,
			@PathVariable("examName") String examName, @RequestHeader HttpHeaders token, HttpSession httpSession)
			throws GSmartBaseException {
		Loggers.loggerStart();
	...
	public ResponseEntity<Map<String, byte[]>> generatePDF(@PathVariable("academicYear") String academicYear,
			@PathVariable("examName") String examName, @RequestHeader HttpHeaders token, HttpSession httpSession)
			throws GSmartBaseException, DocumentException {
		Loggers.loggerStart();
	...
	public ResponseEntity<Map<String, Object>> getChildTeacherNStandard(@RequestHeader HttpHeaders token,
	...
	public ResponseEntity<Map<String, Object>> getExamsForTeacher(@RequestHeader HttpHeaders token,
			HttpSession httpSession, @PathVariable("academicYear") String academicYear,
	...
	public ResponseEntity<Map<String, Object>> getReportCardForHOD(@RequestHeader HttpHeaders token,
			HttpSession httpSession, @PathVariable("examName") String examName,
			@PathVariable("academicYear") String academicYear, @PathVariable("smartId") String smartId)
			throws GSmartBaseException {
