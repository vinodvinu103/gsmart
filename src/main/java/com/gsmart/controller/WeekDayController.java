...
public class WeekDayController {
	...
	public ResponseEntity<Map<String, Object>> getWeekDaysList(@PathVariable("hierarchy") Long hierarchy,
		...
		/*
		 * for (WeekDays weekDays : weekofflist) { int
		 * num=Integer.parseInt(weekDays.getWeekDay()); String
		 * day=DayOfWeek.of(num).toString();
	...
	public ResponseEntity<Map<String, Object>> addWeekDays(@PathVariable("hierarchy") Long hierarchy,
			@RequestBody WeekDays weekDays, @RequestHeader HttpHeaders token, HttpSession httpSession)
