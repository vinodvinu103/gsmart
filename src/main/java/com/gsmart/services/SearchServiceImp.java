...
public class SearchServiceImp implements SearchService {
			...
			if (childList.get(0).getRole().toLowerCase().equals("student")) {
				...
				do {
					...
					if (!gotoloop.isEmpty()) {
						...
						/*
						 * }else { Loggers.loggerValue("sumup ended", "");
						 * return childList; }
						 */
	...
	@Override
	public ArrayList<Profile> studentFees(ArrayList<Profile> childList, String academicYear, String role,
			Hierarchy hierarchy) throws GSmartServiceException {
